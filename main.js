...
const async = (() => {
    const getWeather = async (location) => {
        try {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_0___default().loadError();
        }
    };
...
const controller = (() => {
    ...
    const changeLocation = (event) => {
        ...
        const weatherData = _async__WEBPACK_IMPORTED_MODULE_2__["default"].getWeather(location);
    };
